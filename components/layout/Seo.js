...
function SEO({ data, settings }) {
    ...
    // Site verification tags and any other site-wide head snippets come from
    // the CMS "other_common_scripts" setting.
    const commonScripts = HTMLParser(typeof settings?.other_common_scripts === 'string'
