    ...
    >
      <div className='container' >
        ...
        <motion.div
          ...
          variants={mapRise}
        >
          <Image src={Map1} alt='Map of our associate locations' width={910} height={315} />
          ...
          {associateLocations && associateLocations.map((loc, index) => (
            ...
            >
              ...
              <div className='absolute left-[-36px] md:left-0 top-[100%] bg-white p-[10px] rounded-[15px] associates_list_opt'>
                {
                  loc?.media_id?.file_path && <Image src={loc?.media_id?.file_path} alt={loc?.media_id?.alt_text || `Associate location ${index + 1}`} width={910} height={315} />
                }
